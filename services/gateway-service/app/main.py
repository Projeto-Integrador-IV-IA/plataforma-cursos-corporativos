"""Ponto de entrada do gateway-service.

Porta de entrada unica: autenticacao, roteamento e agregacao para o frontend.
...
def create_app() -> FastAPI:
    ...
    application = FastAPI(title="gateway-service", version="0.1.0")
